    ...
    >
      ...
      <div className='admin-consignment-manage'>
        <div className='admin-consignment-manage-data'>
          <h1 className='admin-consignment-manage-data-title'>ALL CONSIGNMENTS</h1>
          <input
              type='text'
          ...
          <table className='admin-consignment-manage-data-table'>
            <thead className='admin-consignment-manage-data-table-head'>
              <tr className='admin-consignment-manage-data-table-row-head'>
                <th className='admin-consignment-manage-data-table-header'>Item Name</th>
                <th className='admin-consignment-manage-data-table-header'>Item Quantity</th>
                <th className='admin-consignment-manage-data-table-header'>Item HSN</th>
                <th className='admin-consignment-manage-data-table-header'>Item Price</th>
                <th className='admin-consignment-manage-data-table-header'>Item Tax Rate</th>
                <th className='admin-consignment-manage-data-table-header'>Action</th>
              </tr>
            </thead>
            <tbody className='admin-consignment-manage-data-table-body'>
              {displayedConsignedSearch.map((item) => (
                  <tr key={item._id} className='admin-consignment-manage-data-table-row-body'>
                    <td className='admin-consignment-manage-data-table-data highlight'>{item.itemname}</td>
                    <td className='admin-consignment-manage-data-table-data'>{item.itemquantity}</td>
                    <td className='admin-consignment-manage-data-table-data'>{item.itemhsn}</td>
        ...
        <div className='admin-consignment-manage-form'>
          ...
          <form className='admin-consignment-manage-form-form' onSubmit={handleFormSubmit}>
            <input
              type='text'
              required
