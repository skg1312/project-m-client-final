...
function AdminSellerManage() {
	...
	const displayedSellerSearch = sortedSellers
		.filter((item) => {
			...
			if (
				sellerCompanyName.toLowerCase().includes(searchInput?.toLowerCase())
			) {
				return true;
			}
					...
					>
						...
						<input
							...
							onChange={(e) =>
								setSelectedSellerData({
									...selectedSellerData,
									sellercompanygstno: e.target.value,
								})
							}
						/>
						<input
							...
							onChange={(e) =>
								setSelectedSellerData({
									...selectedSellerData,
									sellercompanyaddress: e.target.value,
								})
							}
						/>
						<input
							...
							onChange={(e) =>
								setSelectedSellerData({
									...selectedSellerData,
									sellercompanystatename: e.target.value,
								})
							}
						/>
						<input
							...
							onChange={(e) =>
								setSelectedSellerData({
									...selectedSellerData,
									sellercompanystatecode: e.target.value,
								})
							}
						/>
						{/*
