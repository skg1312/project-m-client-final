                    ...
                    <div className="invoice-form-section">
                        ...
                        <div className="invoice-form-section-inputs">
                            <div className="invoice-form-section-inputs-left">
                                ...
                                <div className="invoice-form-section-inputs-left-input">
                                    <label htmlFor="companyofficeaddress">Company Office Address</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-right-input">
                                    <label htmlFor="sellercompanygstno">Seller Company GST No.</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-right-input">
                                    <label htmlFor="sellercompanyaddress">Seller Company Address</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-right-input">
                                    <label htmlFor="sellercompanystatename">Seller Company State Name</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-right-input">
                                    <label htmlFor="sellercompanystatecode">Seller Company State Code</label>
                                    <input
                            ...
                            <div className="invoice-form-section-inputs-left">
                                ...
                                <div className="invoice-form-section-inputs-left-input">
                                    <label htmlFor="buyercompanygstno">Buyer Company GST No.</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-left-input">
                                    <label htmlFor="buyercompanyaddress">Buyer Company Address</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-left-input">
                                    <label htmlFor="buyercompanystatename">Buyer Company State Name</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-left-input">
                                    <label htmlFor="buyercompanystatecode">Buyer Company State Code</label>
                                    <input
                                ...
                                <div className="invoice-form-section-inputs-right-input">
                                    <label htmlFor="vehicleofficebranch">Vehicle Office Branch</label>
                                    <input
      ...
      >
        Remove
                        ...
                        <div className="invoice-form-section-inputs-left">
                            ...
                            <div className="invoice-form-section-inputs-left-input">
                                <label htmlFor="dispatchdocumentno">Dispatch Document No.</label>
                                <input
