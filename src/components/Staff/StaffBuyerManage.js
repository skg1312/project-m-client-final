...
function StaffBuyerManage() {
  ...
  return (
    ...
    >
      <StaffNavbar />
    <div className='staff-buyer-manage'>
      <div className='staff-buyer-manage-data'>
        <h1 className='staff-buyer-manage-data-title'>ALL BUYERS</h1>
        <input
              type='text'
            ...
            />
        <table className='staff-buyer-manage-data-table'>
          <thead className='staff-buyer-manage-data-table-head'>
            <tr className='staff-buyer-manage-data-table-row-head'>
              <th className='staff-buyer-manage-data-table-header'>Buyer Id</th>
              <th className='staff-buyer-manage-data-table-header'>Company Name</th>
              <th className='staff-buyer-manage-data-table-header'>GST NO</th>
              <th className='staff-buyer-manage-data-table-header'>State Name</th>
              <th className='staff-buyer-manage-data-table-header'>Action</th>
            </tr>
          </thead>
          <tbody className='staff-buyer-manage-data-table-body'>
            {displayedBuyerSearch.map((buyer) => (
              <tr key={buyer._id} className='staff-buyer-manage-data-table-row-body'>
                <td className='staff-buyer-manage-data-table-data highlight'>{buyer.buyerid.substring(0, 12)}</td>
                <td className='staff-buyer-manage-data-table-data'>{buyer.buyercompanyname.substring(0, 12)}</td>
                <td className='staff-buyer-manage-data-table-data'>{buyer.buyercompanygstno.substring(0, 12)}</td>
                <td className='staff-buyer-manage-data-table-data'>{buyer.buyercompanystatename.substring(0, 12)}</td>
                <td className='staff-buyer-manage-data-table-data'>
                  <button
                    className='staff-buyer-manage-data-table-button'
      ...
      <div className='staff-buyer-manage-form'>
        <h1 className='staff-buyer-manage-form-title'>{selectedBuyerId ? 'UPDATE BUYER' : 'ADD BUYER'}</h1>
        <form className='staff-buyer-manage-form-form' onSubmit={handleFormSubmit}>
          <input
            type='text'
            required
            className='staff-buyer-manage-form-input'
          ...
          />
          <br />
          <input type='checkbox' required className='staff-buyer-manage-form-input-checkbox' />
          <label className='staff-buyer-manage-form-input-checkbox-label'>
            I agree with Terms and Conditions & Privacy Policy
          </label>
          <br />
          <button type='submit' className='staff-buyer-manage-form-button'>
