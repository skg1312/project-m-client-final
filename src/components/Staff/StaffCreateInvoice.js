...
function StaffCreateInvoice() {
  const [companies, setCompanies] = useState([]);
    ...
    return (
      ...
      <form className="staff-create-invoice-form-all" onSubmit={handleSubmit}>
  ...
  {vehicles.map((vehicle) => (
    <option key={vehicle._id} value={vehicle._id}>
      ...
      <table className="staff-create-invoice-table-consigment">
                  <thead className="staff-create-invoice-table-thead">
                    <tr className="staff-create-invoice-table-row-head">
                      <th className="staff-create-invoice-table-row-th">
                        Item Name
                      </th>
                      <th className="staff-create-invoice-table-row-th">
                        Item Quantity
                  ...
                  <tbody className="staff-create-invoice-table-tbody">
                    <tr className="staff-create-invoice-table-row-body">
                      <td className="staff-create-invoice-table-row-body-td">
                        <input
                        className='staff-create-invoice-table-consigment-input'
                          type="text"
                          disabled
                      ...
                      <td className="staff-create-invoice-table-row-body-td">
                        <button type="button" 
                        className='staff-create-invoice-table-consigment-button'
                        onClick={() => ConsignmentsAdd()}>
                        <img className='staff-create-invoice-table-consigment-icon' src={A} alt='add'/>
                        </button>
                      </td>
                    </tr>
                    <tr className='staff-create-invoice-table-row-subtitle'>
                    <h3 className='staff-create-invoice-subtitle-table'>ADDED ITEMS</h3>
                      </tr>
                    {dataToSend.consignmentdetails.itemdetails.map(
                      (item, index) => (
                        <tr
                          key={index}
                          className="staff-create-invoice-table-row-body"
                        >
                          <td className="staff-create-invoice-table-consigment-value">
                            {item.itemname}
                          </td>
                          <td className="staff-create-invoice-table-consigment-value">
                            {item.itemquantity}
      ...
      <button className='staff-create-invoice-button'>CREATE INVOICE</button>
    </div>
