...
function UserCompanyManage() {
  ...
  return (
    ...
    >
      <UserNavbar />
    <div className='user-company-manager'>
      <div className='user-company-manager-data'>
        <h1 className='user-company-manager-data-title'>ALL COMPANIES</h1>
        <input
              type='text'
            ...
            />
        <table className='user-company-manager-data-table'>
          <thead className='user-company-manager-data-table-head'>
            <tr className='user-company-manager-data-table-row-head'>
              <th className='user-company-manager-data-table-header '>Company Name</th>
              <th className='user-company-manager-data-table-header'>GST No</th>
              <th className='user-company-manager-data-table-header'>Contact</th>
              <th className='user-company-manager-data-table-header'>Office Address</th>
              <th className='user-company-manager-data-table-header'>Party Type</th>
              <th className='user-company-manager-data-table-header'>Action</th>
            </tr>
          </thead>
          <tbody className='user-company-manager-data-table-body'>
            {displayedCompaniesSearch.map((company) => (
              <tr key={company._id} className='user-company-manager-data-table-row-body'>
                <td className='user-company-manager-data-table-data highlight'>
                  {company.companyname.substring(0, 12)}
                </td>
                <td className='user-company-manager-data-table-data'>
                ...
                <td className='user-company-manager-data-table-data'>
                  <button
                    className='user-company-manager-data-table-button'
      ...
      <div className='user-company-manager-form'>
        <h1 className='user-company-manager-form-title'>
          {selectedCompanyId ? 'UPDATE COMPANY' : 'ADD COMPANY'}
        </h1>
        <form className='user-company-manager-form-form' onSubmit={handleFormSubmit}>
  <input
    type='text'
    required
    className='user-company-manager-form-input-high'
  ...
  <input
    type='text'
    required
    className='user-company-manager-form-input-low'
    placeholder='GST No'
  ...
  />
<br />
          <input type='checkbox' required className='user-company-manage-form-input-checkbox' />
          <label className='user-company-manage-form-input-checkbox-label'>
            I agree with Terms and Conditions & Privacy Policy
          </label>
          <br />
  <button type='submit' className='user-company-manager-form-button'>
    {selectedCompanyId ? 'Update Company' : 'Add Company'}
  </button>
</form>
