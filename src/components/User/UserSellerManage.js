...
import './UserSellerManage.css'
import axios from 'axios';
import background from '../images/Desktop.png';
import ReactPaginate from 'react-paginate';
import UserNavbar from './UserNavbar';

function UserSellerManage() {
  ...
  return (
    ...
    >
      <UserNavbar />
      <div className='user-seller-manage'>
        <div className='user-seller-manage-data'>
          <h1 className='user-seller-manage-data-title'>ALL SELLERS</h1>
          <input
              type='text'
            ...
            />
          <table className='user-seller-manage-data-table'>
  <thead className='user-seller-manage-data-table-head'>
    <tr className='user-seller-manage-data-table-row-head'>
      <th className='user-seller-manage-data-table-header'>Sellers Id</th>
      <th className='user-seller-manage-data-table-header'>Company Name</th>
      <th className='user-seller-manage-data-table-header'>GST NO</th>
      <th className='user-seller-manage-data-table-header'>State Name</th>
      
      <th className='user-seller-manage-data-table-header'>Action</th>
    </tr>
  </thead>
  <tbody className='user-seller-manage-data-table-body'>
    {displayedSellerSearch.map((seller) => (
      <tr key={seller._id} className='user-seller-manage-data-table-row-body'>
        <td className='user-seller-manage-data-table-data highlight'>{seller.sellerid.substring(0, 12)}</td>
        <td className='user-seller-manage-data-table-data'>{seller.sellercompanyname.substring(0, 12)}</td>
        <td className='user-seller-manage-data-table-data'>{seller.sellercompanygstno.substring(0, 12)}</td>
        <td className='user-seller-manage-data-table-data'>{seller.sellercompanystatename.substring(0, 12)}</td>
        
        <td className='user-seller-manage-data-table-data'>
          <button
            className='user-seller-manage-data-table-button'
        ...
        <div className='user-seller-manage-form'>
          <h1 className='user-seller-manage-form-title'>
            {selectedSellerId ? 'UPDATE SELLER' : 'ADD SELLER'}
          </h1>
          <form className='user-seller-manage-form-form' onSubmit={handleFormSubmit}>
            <input
              type='text'
              required
              className='user-seller-manage-form-input'
            ...
            <br />
            <button type='submit' className='user-seller-manage-form-button'>
...
export default UserSellerManage;